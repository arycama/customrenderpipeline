...
namespace Arycama.CustomRenderPipeline
{
    ...
    public class WaterRenderer : MonoBehaviour
    {
        ...
        [SerializeField] private int patchVertices = 32;
        ...
        public void Cull(CommandBuffer command, Vector3 viewPosition, Vector4[] cullingPlanes)
        {
            ...
            command.SetComputeIntParam(compute, "_CullingPlanesCount", cullingPlanes.Length);
