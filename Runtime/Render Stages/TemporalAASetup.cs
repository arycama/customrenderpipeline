...
{
    public class TemporalAASetup : RenderFeature
    {
        ...
        public override void Render()
        {
            ...
            (
                renderGraph.SetConstantBuffer((
                    new Vector4(jitter.x, jitter.y, jitter.x / viewData.ScaledWidth, jitter.y / viewData.ScaledHeight),
                    new Vector4(previousJitter.x, previousJitter.y, previousJitter.x / viewData.ScaledWidth, previousJitter.y / viewData.ScaledHeight),
                    crossWeightSum,
                    boxWeightSum,
