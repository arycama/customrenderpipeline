public static class RenderGraphExtensions
{
	...
	public static FullscreenTerrainRenderPass<T> AddFullscreenTerrainRenderPass<T>(this RenderGraph renderGraph, string name, T data) => renderGraph.AddRenderPass<FullscreenTerrainRenderPass<T>, T>(name, data);
	...
	public static SetPropertyBlockPass<T> AddSetPropertyBlockPass<T>(this RenderGraph renderGraph, string name, T data) => renderGraph.AddRenderPass<SetPropertyBlockPass<T>, T>(name, data);
	...
	public static FullscreenTerrainRenderPass<int>AddFullscreenTerrainRenderPass(this RenderGraph renderGraph, string name) => AddFullscreenTerrainRenderPass(renderGraph, name, 0);
	...
	public static SetPropertyBlockPass<int>AddSetPropertyBlockPass(this RenderGraph renderGraph, string name) => AddSetPropertyBlockPass(renderGraph, name, 0);
