...
public readonly struct AttachmentData
{
    ...
    public AttachmentData(ResourceHandle<RenderTexture> handle, RenderTargetIdentifier frameBufferTarget, GraphicsFormat frameBufferFormat = default, bool isFrameBufferOutput = false, int mipLevel = 0, CubemapFace cubemapFace = CubemapFace.Unknown, int depthSlice = -1)
    {
        this.handle = handle;
