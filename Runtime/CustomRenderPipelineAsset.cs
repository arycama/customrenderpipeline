...
namespace CustomRenderPipeline
{
    ...
    {
        [field: SerializeField] public int MaxQueuedFrames { get; private set; } = 2;
        ...
        public override Type pipelineType => typeof(StandardRenderPipeline);
        ...
        {
            return new StandardRenderPipeline(this);
        }
    }
}