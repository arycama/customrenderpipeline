...
namespace CustomRenderPipeline
{
    public readonly struct PointLightData : IRenderPassData
    {
        ...
        public PointLightData(ResourceHandle<GraphicsBuffer> dataBuffer, ResourceHandle<GraphicsBuffer> lightBuffer, int lightCount, ResourceHandle<GraphicsBuffer> lightDepthMinMaxBuffer, ResourceHandle<RenderTexture> visibleLightBits)
        {
