...
public class WaterCaustics : CameraRenderFeature
{
    ...
    public override void Render(Camera camera, ScriptableRenderContext context)
    {
        ...
        var tempResult = renderGraph.GetTexture(settings.CasuticsResolution * 2, settings.CasuticsResolution * 2, GraphicsFormat.B10G11R11_UFloatPack32, isExactSize: true);
        using (var pass = renderGraph.AddRenderPass<GenericRenderPass>("Ocean Caustics Render"))
        {
