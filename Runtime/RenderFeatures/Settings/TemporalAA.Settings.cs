...
public partial class TemporalAA
{
    ...
    public class Settings
    {
        ...
        [field: SerializeField, Range(0f, 2f)] public float SpatialSize { get; private set; } = 4.0f / 3.0f;
        [field: SerializeField, Range(0f, 2f)] public float SpatialBlur { get; private set; } = 0.0f;
        [field: SerializeField, Range(0f, 8f)] public float SpatialSharpness { get; private set; } = 0.5f;
