	...
	public static readonly Float3[] lookAtList =
{
	...
	public static Matrix4x4 PixelToNearClip(int width, int height, Vector2 jitter, float tanHalfFov, float aspect)
	{
		return new Matrix4x4
		{
			m00 = aspect * tanHalfFov * 2.0f / width,
			m11 = tanHalfFov * 2.0f / height,
			m02 = -aspect * tanHalfFov * (1.0f - jitter.x),
			m12 = -tanHalfFov * (1.0f + jitter.y),
			m22 = 1.0f,
			m33 = 1.0f
		};
	}
